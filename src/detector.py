...
class PumpDetector:
    ...
    def __init__(self):
        ...
        # ============================================================
        self._semaphore = asyncio.Semaphore(self.MAX_CONCURRENT)  # ← ДОБАВИТЬ
        # ============================================================
    ...
    async def scan_all_symbols_async(self):
        ...
        # ============================================================
        tasks = [self._check_pump_with_semaphore(symbol) for symbol in symbols_to_check]
    ...
    # ОБЁРТКА С СЕМАФОРОМ
    # ============================================================
    async def _check_pump_with_semaphore(self, symbol):
        async with self._semaphore:
            return await self._check_pump_async(symbol)
    # ============================================================
